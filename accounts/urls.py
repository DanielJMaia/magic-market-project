...
from .views import login, logout, register, view_user, view_profile, view_all_user_cards, view_history, change_password
...
urlpatterns = [
    ...
    url(r'^reset/$', change_password, name="change_password"),
